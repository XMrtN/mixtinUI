...
`,
  ...
  {
    title: "HTML + CSS",
    code: `<button class="button9">
  <div class="button9__div button9__div--first">Hover me</div>
  <div class="button9__div button9__div--second">Hover me</div>
</button>
...
<style>
  ...
  .button9:hover .button9__div--first {
  ...
  .button9:hover .button9__div--second {
